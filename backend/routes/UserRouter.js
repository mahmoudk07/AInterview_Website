...
import { Login, Signup, getAllUsers, getUserByID, deleteAllUsers, deleteUserByID, UpdatePassword } from "../controllers/UserController.js"
...
router.patch('/changePassword', IsAuthorized , UpdatePassword)
